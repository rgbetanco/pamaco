 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public class CreatePDFConfirmNote extends DBBaseDAO {
	...
	public CreatePDFConfirmNote(int idParm) {
		this.idLocal = idParm;
	...
	public void addHeaderEnglish() throws Exception {
		...
		try {
			...
			Phrase ph2 = new Phrase("Confirmation Note", FontFactory.getFont(FontFactory.COURIER_BOLD, 14, Font.NORMAL, new Color(0, 128, 0)));
	...
	public void addDetailEnglish() throws Exception {
		...
		Paragraph p8 =
			new Paragraph(
				new Chunk(
					"Please present this "
						+ "file to the hotel. This file is created after the"
						+ " hotel administrator confirm it. If you need to cancel or "
						+ "make any change write an email to us, or cancel it thought the"
						+ " web site. Thank you for prefer us.",
					FontFactory.getFont(FontFactory.COURIER_BOLD, 12)));

		p8.indentationRight();
		p8.setAlignment(Element.ALIGN_JUSTIFIED);
		
		Chunk c9 = new Chunk("Favor, presentar este archivo en "
		+ "el hotel. Este archivo es creado al ser confirmada su reservacion por "
		+ "el hotel. Si usted necesita cancelar su reservacion lo puede hacer "
		+ "atraves de nuestro correo electronico o nuestro sitio web",
		FontFactory.getFont(FontFactory.COURIER_BOLD, 12));
		...
		Chunk ph9 = new Chunk("to Cancel Reservation; Para Cancelar la reservacion", FontFactory.getFont(FontFactory.HELVETICA, 9, Font.UNDERLINE, new Color(0, 0, 255))).setAnchor(new URL("http://127.0.0.1:9080/hotelreserve/showLogin.do"));
		doc.add(ph9);
