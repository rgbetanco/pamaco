...
import com.nicahost.module.hotelreserve.admin.form.RoomTypeForm;
 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public class UpdateRoomType extends AdminBaseAction {
	...
	public ActionForward adminExecuteAction(
		...
		RoomTypeForm frm = (RoomTypeForm) form;
			
		HotelAdminService service = HotelAdminService.getInstance();
		if (service.updateRoomType(frm.getRoomTypeId(),frm.getDescription())) {
