 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public class InsertPlanRate extends AdminBaseAction {
	...
	public ActionForward adminExecuteAction(
		...
		if (service.insertPlanRate(frm.getName(),frm.getPrice(),frm.getAdditional(),frm.getMinNights(),frm.getIniDate(),frm.getEndDate(),frm.getActive(),frm.getMaxGuests())) {
