...
import com.nicahost.module.hotelreserve.admin.form.Step01Form;
 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public class showAvailability extends BaseAction {
	...
	public ActionForward executeAction(
		...
		throws Exception {
			...
			//de la reserva.  hjiron en un inicio, ya te cambie totalmente esta clase RGB
			...
			//Collection languages = service.getLanguage(); depracated for now
			
			//Guardar objetos en el form si en caso es la primera vez que se ejecuta la pagina
			if (submitted == null){
			...
			String datediffs = service.daysDiff(cal1, cal2);
			...
			request.setAttribute("defaultNights",service.daysDiff(cal1, cal2));
