 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public class DeleteRoomPlan extends AdminBaseAction {
	...
	public ActionForward adminExecuteAction(
		...
		if (service.deletePlanRateForRoom(frm.getRoomId(),planno)) {
			saveMessage(request,"msg.delete.success", "1");
		} else {
			saveError(request,"msg.delete.failure");
		}
