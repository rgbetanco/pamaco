	...
	<TBODY>
			...
			<TR>
				...
				<TD>
					<html:select property="roomTypeId">
						<html:options collection="roomTypes" property="value" labelProperty="label"/>
					</html:select>
				</TD>
			</TR>
			<TR>
		...
		<TR>
			<TD colspan="2">
				...
				<INPUT type="button" onclick="window.location.replace('showRoomInsert.do')" value="Cancelar">
