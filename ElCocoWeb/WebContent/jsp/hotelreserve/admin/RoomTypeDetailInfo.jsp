...
<TABLE border="0">
	<TBODY>
		<TR>
			<TH><a href="/ElCocoWeb/admin/showRoomTypeDetail.do?ob=roomTypeId">Código</a></TH>
			<TH><a href="/ElCocoWeb/admin/showRoomTypeDetail.do?ob=description">Descripción</a></TH>
			<TH>Acciones</TH>
		</TR>
